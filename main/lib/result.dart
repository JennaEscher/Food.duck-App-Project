...
class Result extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(//공통 앱바부분 이부분은 복붙하고 안고침
      ...
      body: Padding(//스크롤(열(컨테이너(행(가게이름,오리아이콘)),컨테이너(열(가게사진,설명,컨테이너(짧은설명문))))) 형태로 구성됨
                    ...
                    Container(
                      ...
                      child:RichText(
                        text:TextSpan(
                          ...
                          style: const TextStyle(
                              fontSize: 20,
                              fontFamily: letterstyle, color: Color.fromRGBO(0, 0, 0, 1),
                              )
                          ),
